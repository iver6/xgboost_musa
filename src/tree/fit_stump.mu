...
#include <thrust/execution_policy.h>            // musa::par
#include <thrust/iterator/counting_iterator.h>  // thrust::make_counting_iterator

#include <cstddef>  // std::size_t

#include "../collective/aggregator.muh"  // for GlobalSum
#include "../common/device_helpers.muh"  // dh::MakeTransformIterator
#include "fit_stump.h"
...
namespace xgboost::tree::musa_impl {
void FitStump(Context const* ctx, MetaInfo const& info,
  ...
  auto policy = thrust::musa::par(alloc);
