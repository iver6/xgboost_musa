...
#include "musa_context.muh"                     // CUDAContext
#include "device_helpers.muh"                   // dh::MakeTransformIterator, tcbegin, tcend
#include "optional_weight.h"                    // common::OptionalWeights
#include "stats.muh"          // common::SegmentedQuantile, common::SegmentedWeightedQuantile
#include "xgboost/base.h"     // XGBOOST_DEVICE
#include "xgboost/context.h"  // Context
#include "xgboost/host_device_vector.h"  // HostDeviceVector
#include "xgboost/linalg.h"              // linalg::TensorView, UnravelIndex, Apply

namespace xgboost::common::musa_impl {
void Median(Context const* ctx, linalg::TensorView<float const, 2> t,
  ...
  dh::LaunchN(d_segments.size(), ctx->MUSACtx()->Stream(),
